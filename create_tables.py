...
def drop_tables(cur, conn):
    ...
    try:
        for query in drop_table_queries:
            print("drop table has been started")
            cur.execute(query)
            conn.commit()
            print("drop table has been completed")
        print("*Drop Table*")        
...
def create_tables(cur, conn):
    ...
    try:
        for query in create_table_queries:
            ...
            print("Create table has been started".format(query))
            cur.execute(query)
            conn.commit()
            print("Create table has been completed".format(query))
